<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Import', 'easy-image-collage') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', 'easy-image-collage') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'easy-image-collage') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Export', 'easy-image-collage') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', 'easy-image-collage') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'easy-image-collage') ?>" />
				<span style="margin-left: 10px;">
